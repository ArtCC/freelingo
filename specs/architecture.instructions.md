...
│   ├── tests/                   # Vitest suite (37 test files, 433 tests)
...
- **Backend**: pytest + pytest-asyncio, 43 test files, 935 tests, 84.30% last measured coverage (target: 70%)
- **Frontend**: Vitest, 37 test files, 433 tests covering stores, components, hooks, lib, i18n, app pages, billing paywall UI, billing success verification, feedback unread labels, SSE parsing, memory toasts, and middleware; coverage is not configured/reported
